            ...
            <div class="repo_list">
                <div class="repo_info">
                    ...
                    <div class="content_info null">
                            ...
                            </span><span class="tab_name_span"> ${el.stargazerCount ? el.stargazerCount : null}</span> 
                    </div>
                    <div class="content_info null">
                            <span class="repo_info_svg_parent">
                            ...
                            </span><span class="tab_name_span"> ${el.forkCount ? el.forkCount : null}</span>
                    </div>
                        <div class="content_info">
                            <span>Updated ${el.updatedAt ? timeSince(new Date(el.updatedAt)) : null}</span>
                        </div>
